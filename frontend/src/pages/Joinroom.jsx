        ...
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="bg-gray-900 p-4 rounded-full shadow-lg">
              <Code2 className="h-12 w-12 text-gray-300 drop-shadow-lg" />
            </div>
          </div>
        ...
        <CardContent>
          <form className="space-y-6" onSubmit={e => { e.preventDefault(); joinroom(e); }}>
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="bg-black border border-blue-500/20 text-white placeholder:text-blue-200/50 focus:ring-2 focus:ring-blue-500/40 focus:border-blue-400 transition"
                />
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="bg-black border border-blue-500/20 text-white placeholder:text-blue-200/50 focus:ring-2 focus:ring-purple-500/40 focus:border-purple-400 transition"
                />
                {roomid && (
                  <button
                    type="button"
                    onClick={copyToClipboard}
                    className="absolute right-10 top-3 text-white transition-colors"
                    tabIndex={-1}
                  >
            ...
            <div className="flex flex-col gap-4">
              ...
              <Button
                type="submit"
                className="w-full cursor-pointer bg-gray-900 border border-gray-800 text-blue-200 hover:bg-blue-500/20 font-semibold py-3 rounded-lg shadow transition-all duration-200"
              >
                Join Room
              </Button>
            </div>
