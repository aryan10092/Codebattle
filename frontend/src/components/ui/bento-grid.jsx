...
const BentoGrid = ({
  ...
  return (
    <div
      className={cn("grid w-full auto-rows-[22rem] grid-cols-1 md:grid-cols-3 gap-4 max-w-6xl mx-auto px-4", className)}
      {...props}>
      {children}
    </div>
  );
...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "bg-[#0A0909] transform-gpu [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] [border:1px_solid_rgba(255,255,255,.1)]",
      className
    )}
    {...props}>
